...
def increase_volume():
    """Increase volume"""
    adjust_volume(0.1)  # Increase volume by 10%

def decrease_volume():
    """Decrease volume"""
    adjust_volume(-0.1)  # Decrease volume by 10%
        ...
        while cap.isOpened():
            ...
            if results.multi_hand_landmarks:
                for hand_landmarks in results.multi_hand_landmarks:
                    ...
                    if thumb_tip_x < w / 2 and index_tip_x > w / 2:  # Swipe right
                        increase_volume()
                    elif thumb_tip_x > w / 2 and index_tip_x < w / 2:  # Swipe left
                        decrease_volume()
